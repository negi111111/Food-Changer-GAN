...
if __name__ == '__main__':
    ...
    parser.add_argument('--rafd_crop_size', type=int, default=512)
    ...
    # Path
    parser.add_argument('--celebA_image_path', type=str, default='./data/10c_images_256')
    parser.add_argument('--rafd_image_path', type=str, default='./data/fmd/train')
    parser.add_argument('--metadata_path', type=str, default='./data/label10k.txt')
    ...
    parser.add_argument('--sample_path', type=str, default='./results/samples')
    parser.add_argument('--result_path', type=str, default='./results/results')

    # Step size
    parser.add_argument('--log_step', type=int, default=10)
    parser.add_argument('--sample_step', type=int, default=997)
    parser.add_argument('--model_save_step', type=int, default=1994)
